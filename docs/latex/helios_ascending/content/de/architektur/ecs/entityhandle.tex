...
Anschaulich lässt sich ein solches Handle mit dem Schema einer Datenbank vergleichen, in der eine Tabelle ausschließlich Schlüssel (die \textit{EntityHandles}) zur Referenzierung von Einträgen anderer Tabellen (die \textit{Sparse Sets}) enthält.
...
Zur Markierung ungültiger Positionen in den \textit{Sparse Sets} werden sogenannte \textit{Tombstones} verwendet; dadurch lässt sich die Gültigkeitsprüfung effizient gestalten.
