...
Die eindeutige Identifizierung eines solchen Objekts, das im Kern eine lose Sammlung von Komponenten darstellt, erfolgt zur Laufzeit ausschließlich über diesen zusammengesetzten Schlüssel.\footnote{
Zur Veranschaulichung eignet sich das Schema einer Datenbank, in der eine Tabelle ausschließlich Fremdschlüssel zur Referenzierung von Einträgen anderer Tabellen enthält.
}
...
Sollte die \textit{Free List} keine Einträge enthalten, wird der zugrunde liegende Vektor um einen neuen Eintrag erweitert und mit der Versionsnummer $1$ versehen.
