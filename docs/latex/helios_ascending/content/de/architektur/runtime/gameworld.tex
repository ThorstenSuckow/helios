...
Eine Ausnahme bilden die Views auf die verschiedenen Systeme, auf die vo
n der GameWorld aus zugegriffen werden kann, wie \texttt{managers()} und \texttt{commandHandlers()}, die einen \texttt{std::span} auf die über die intern über TypeErasure gespeicherten INstanzen zurückliefern.
