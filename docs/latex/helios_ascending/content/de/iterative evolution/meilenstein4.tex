...
Die Gruppierung von Komponenten hinter einfacher lesbaren Methoden, die über ein \textit{Fluent Interface}~\cite{FluentInterface} realisiert wurden, reduzieren den Quellcode zwar nicht wesentlich, machen ihn aber intuitiv verständlicher.
