...
Der in diesem Zusammenhang implementierte \textit{Expression Builder}~\cite[S. 343-350]{FP11} erlaubt die Konfiguration von \textit{GameObjects} wie Spielern, Gegnern, Projektilen und Spielfiguren.
