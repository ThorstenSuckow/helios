...
Das Kürzel \textit{Id} (und seine Pluralform \textit{Ids}) wird in diesem Dokument anstelle des Begriffs \textit{Identifier} verwendet.\\
...
Auch hier ergibt sich die jeweils gemeinte Bedeutung aus dem Kontext.\\
...
Weitere Begriffserklärungen finden sich im Anhang im Glossar~\ref{ch:glossar}.