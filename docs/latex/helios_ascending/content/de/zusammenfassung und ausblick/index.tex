...
Ob mit der in Abschnitt~\ref{sec:ki} beschriebene und als hilfreich empfundene Unterstützung durch KI auch eine messbare Produktivitätssteigerung einhergeht, bleibt offen.
Da die Verantwortung für fachliche Korrektheit und Integration weiter bei den Autoren liegt, müssen die vorgeschlagenen Änderungen erneut einer Überprüfung unterzogen werden - ein Schritt, der die eigentliche Rolle der KI als ein fachlicher Assistent auf ein Werkzeug reduziert, das Vorschläge generiert - die autoritative Kontrolle verbleibt damit beim Entwickler.
...
Damit bedeutete die Überprüfung der von Copilot generierten Quellcodekommentare und Dokumentation eine zusätzliche Arbeitslast, was durch Studien belegt wird~\cite{METRStudy}.
Hinweise, dass damit auch ein wesentlicher Teil der Retrospektive verloren geht, in der sich ein Entwickler üblicherweise mit dem erschaffenen Quellcodekonstrukt auseinandersetzt, finden sich beispielsweise bei Catalan et al.~\cite{CDMK26}.
