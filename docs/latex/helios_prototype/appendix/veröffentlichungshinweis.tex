...
\subsection*{Zitiervorschlag (Bib\TeX)}
\begingroup\small
\begin{verbatim}
@techreport{SuckowHomberg2025HeliosTR,
  author      = {Suckow-Homberg, Thorsten},
  title       = {helios: Konzeption und prototypische Umsetzung eines C++ Game Frameworks},
  institution = {Hochschule Trier, Fachbereich Informatik},
