\begin{abstract}
    Wir stellen \textit{helios} vor, einen in C++ entwickelten Prototyp eines Game Frameworks zur Umsetzung eines Geometry Wars Klons.
...
\keywords{game engines, prototyping, software design, architecture, c++, game development}