...
Unsere Recherche hat jedoch gezeigt, dass nicht nur datenorientierte Systeme gemeinhin den Unterbau effizienter Spiele(-Engines) bilden~\cite{Bay22}, sondern auch eine möglichst optimale Vorbereitung und Weitergabe der Renderinstruktionen an das Rendering-Backend dazugehört.
