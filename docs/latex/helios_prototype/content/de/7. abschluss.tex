...
Unsere Recherche hat jedoch gezeigt, dass datenorientierte Systeme gemeinhin den Unterbau effizienter Spiele(-Engines) bilden~\cite{Bay22}:
...
Darüber hinaus gehört eine möglichst optimale Vorbereitung und Weitergabe der Renderinstruktionen an das Rendering-Backend zur Leistungsverbesserung von Spielen.
Hier wird sich unser Entwurf erst in der Praxis beweisen müssen.
\\
