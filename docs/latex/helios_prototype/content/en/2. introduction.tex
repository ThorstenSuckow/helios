...
the software is being created as part of an agile \textit{Tracer Bullet Development} process~\cite[pp.~50]{TH20}, allowing the entire system to be adapted on short notice if necessary.
...
Although there are no plans to classify the finished product according to usability quality characteristics such as those defined in ISO/IEC 9126\footnote{``Usability quality according to ISO/IEC 9126''~\cite[466]{Bal08}; see also studies and investigations in~\cite[]{AZMK17},~\cite[]{Ber10}.},
