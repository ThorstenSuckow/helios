...
} \textit{Geometry Wars} (see Figure~\ref{fig:geometry_wars}) using the programming language C++23 and the OpenGL~API~\cite[]{OpenGLHomepage}.\\

\begin{figure}[tbp]
    \centering
    \includegraphics[width=\textwidth]{img/geometry_wars}
    \caption{\textit{Geometry Wars} first appeared in 2003 as an Easter egg in the game \textit{Project Gotham Racing 2} (Microsoft Game Studios).
