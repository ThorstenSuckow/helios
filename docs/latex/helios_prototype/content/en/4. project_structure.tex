...
\textit{helios} uses \texttt{glm} as a test oracle~\cite[pp.~917]{Bin99} for comparison purposes.\footnote{
...
With C++23, \textit{helios} implements its classes and functions entirely through Module Interface and Implementation Units~\cite[pp.~211]{Str24}.
