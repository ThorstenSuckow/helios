...
export namespace helios::examples::spaceshipControl {
    ...
    private:
        struct SpaceshipEntry {
            std::string name;
            helios::examples::spaceshipControl::Spaceship* spaceship = nullptr;
        };

        std::vector<SpaceshipEntry> spaceships_;
        int selectedIndex_ = 0;

        [[nodiscard]] helios::examples::spaceshipControl::Spaceship* getSelectedSpaceship() noexcept {
    ...
    public:
         ...
         */
        void addSpaceship(const std::string& name, helios::examples::spaceshipControl::Spaceship* spaceship) {
