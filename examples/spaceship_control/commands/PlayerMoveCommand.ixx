...
#define HELIOS_LOG_SCOPE "helios::examples::spaceshipControl::commands::PlayerMoveCommand"
export namespace helios::examples::spaceshipControl::commands {
    ...
    public:
         ...
         */
        void execute(helios::examples::spaceshipControl::Spaceship& spaceship) {
