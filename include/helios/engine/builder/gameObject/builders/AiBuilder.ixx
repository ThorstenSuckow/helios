...
export namespace helios::engine::builder::gameObject::builders {
    ...
    public:
         ...
         */
        [[nodiscard]] helios::engine::builder::gameObject::builders::configs::ChaseConfig<Entity> chasing() const {
            return helios::engine::builder::gameObject::builders::configs::ChaseConfig<Entity>{gameObject_};
        }
