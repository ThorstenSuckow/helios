/**
 * @file _module.ixx
 * @brief Module aggregation for helios.engine.builder.gameObject.builders.
 */
module;

export module helios.engine.builder.gameObject.builders;

export import helios.engine.builder.gameObject.builders.configs;

export import helios.engine.builder.gameObject.builders.MotionBuilder;
export import helios.engine.builder.gameObject.builders.RenderingBuilder;
