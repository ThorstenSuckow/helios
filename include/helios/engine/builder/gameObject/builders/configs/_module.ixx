/**
 * @file _module.ixx
 * @brief Module aggregation for helios.engine.builder.gameObject.builders.configs.
 */
module;
...
export import helios.engine.builder.gameObject.builders.configs.CollisionConfig;
export import helios.engine.builder.gameObject.builders.configs.LevelBoundsCollisionConfig;
export import helios.engine.builder.gameObject.builders.configs.GfxEffectsConfig;
...
export import helios.engine.builder.gameObject.builders.configs.TextRenderableConfig;
export import helios.engine.builder.gameObject.builders.configs.UiTransformConfig;
export import helios.engine.builder.gameObject.builders.configs.HealthConfig;
export import helios.engine.builder.gameObject.builders.configs.CombatConfig;
