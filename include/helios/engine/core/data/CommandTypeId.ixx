...
export module helios.engine.core.data.CommandTypeId;
...
export namespace helios::engine::core::data {
    ...
    class CommandTypeId {
         ...
         */
        struct helios_engine_core_data_CommandTypes{};

        using ComponentType = helios_engine_core_data_CommandTypes;
