...
export namespace helios::engine::core::data {
     ...
     * Enables type-safe referencing of scenes by name (e.g., "Ui", "Game").
     */
    struct SceneId {
    ...
    private:
         ...
         */
        explicit constexpr SceneId(const uint32_t id) noexcept
            : id_(id) {
        }
    ...
    public:
        ...
        /**
         * @brief Constructs a SceneId from a string name.
         *
         ...
         */
        explicit constexpr SceneId(const std::string_view str) noexcept
            : SceneId(helios::core::algorithms::fnv1a_hash(str)) {}

        explicit constexpr SceneId(helios::core::types::no_init_t) {};
         ...
         */
        friend constexpr bool operator==(SceneId, SceneId) noexcept = default;

        /**
         * @brief Less-than comparison for ordered containers.
         *
         * @param other The SceneId to compare against.
         *
         * @return `true` if this id is less than `other`.
         */
        constexpr bool operator<(const SceneId& other) const noexcept {
...
/**
 * @brief Hash specialization for `SceneId` to enable use in unordered containers.
 */
template<>
struct std::hash<helios::engine::core::data::SceneId> {

    /**
     * @brief Computes the hash value for a SceneId.
     *
     * @param id The SceneId to hash.
     *
