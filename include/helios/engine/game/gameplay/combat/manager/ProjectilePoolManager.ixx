...
export namespace helios::engine::game::gameplay::combat::manager {
    ...
    public:
         ...
         */
        bool submit(helios::engine::game::gameplay::spawn::requests::SpawnRequest spawnRequest) noexcept override {
         ...
         */
        bool submit(helios::engine::game::gameplay::spawn::requests::DespawnRequest despawnRequest) noexcept override {
