...
export namespace helios::engine::game::gameplay::spawn::manager {
    ...
    class SpawnManager : public helios::engine::game::Manager, public helios::engine::game::PoolRequestHandler {
         ...
         */
        std::vector<helios::engine::game::gameplay::spawn::requests::SpawnRequest> spawnRequests_;

        /**
         * @brief Queue of pending despawn requests.
         */
        std::vector<helios::engine::game::gameplay::spawn::requests::DespawnRequest> despawnRequests_;
         ...
         */
        void prepareSpawn(
            const helios::engine::game::gameplay::spawn::requests::SpawnRequest& spawnRequest
        ) const noexcept {
    ...
    public:
         ...
         */
        bool submit(const helios::engine::game::gameplay::spawn::requests::SpawnRequest request) noexcept override {
         ...
         * @return Always returns true.
         */
        bool submit(const helios::engine::game::gameplay::spawn::requests::DespawnRequest request) noexcept override {
