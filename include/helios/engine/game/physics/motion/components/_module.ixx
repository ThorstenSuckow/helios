/**
 * @file _module.ixx
 * @brief Aggregate module for helios::engine::game::physics::motion::components namespace.
 */
export module helios.engine.game.physics.motion.components;

export import helios.engine.game.physics.motion.components.DirectionComponent;
