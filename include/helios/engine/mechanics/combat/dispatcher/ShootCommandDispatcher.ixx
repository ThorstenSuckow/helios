...
export module helios.engine.mechanics.combat.dispatcher.ShootCommandDispatcher;
...
export namespace helios::engine::mechanics::combat::dispatcher {
    ...
    class ShootCommandDispatcher final : public helios::engine::core::messaging::command::TypedTargetedCommandDispatcher<
         ...
         */
        helios::engine::mechanics::combat::manager::ProjectilePoolManager& projectilePoolManager_;
    ...
    public:
        ...
        explicit ShootCommandDispatcher(
            helios::engine::mechanics::combat::manager::ProjectilePoolManager& projectilePoolManager
        ) :
