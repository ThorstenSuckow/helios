/**
 * @file _module.ixx
 * @brief Module facade for scoring types.
 */
export module helios.engine.mechanics.scoring.types;

export import helios.engine.mechanics.scoring.types.KillReward;
