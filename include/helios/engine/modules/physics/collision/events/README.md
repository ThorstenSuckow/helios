...
This namespace contains event structures dispatched by the collision detection system. Events are placed in the `GameLoopEventBus` for consumption by gameplay systems in the next frame.
