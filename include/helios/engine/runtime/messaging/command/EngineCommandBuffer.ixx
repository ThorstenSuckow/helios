...
export namespace helios::engine::runtime::messaging::command {
    ...
    using EngineCommandBuffer = helios::engine::runtime::messaging::command::TypedCommandBuffer<
            ...
            helios::engine::runtime::spawn::commands::ScheduledSpawnPlanCommand<GameObjectHandle>,
            helios::engine::runtime::spawn::commands::SpawnCommand<GameObjectHandle>,
            helios::engine::runtime::spawn::commands::DespawnCommand<GameObjectHandle>,
