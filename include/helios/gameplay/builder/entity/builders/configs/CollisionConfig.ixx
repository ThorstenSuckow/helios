...
export module helios.gameplay.builder.entity.builders.configs.CollisionConfig;
...
export namespace helios::gameplay::builder::entity::builders::configs {
    ...
    class CollisionConfig {
        ...
        void ensureCollisionComponent(const bool isAvailable) const noexcept {
            ...
            auto* cc = entity_.template get<helios::physics::collision::components::CollisionComponent<Handle_type>>();
    ...
    public:
         ...
         */
        explicit CollisionConfig(Entity entity) : entity_(entity) {

            entity.template add<helios::physics::collision::components::CollisionStateComponent<Handle_type>>();
        ...
        CollisionConfig& useBoundingBox() {
            entity_.template add<helios::physics::collision::components::AabbColliderComponent<Handle_type>>();
            return *this;
        }
        ...
        CollisionConfig& layerId(const uint32_t layerId) {
            ...
            entity_.template add<helios::physics::collision::components::CollisionComponent<Handle_type>>(layerId);
         ...
         * @see HitPolicy
         */
        CollisionConfig& hitPolicy(const helios::physics::collision::types::HitPolicy hitPolicy) {

            ensureCollisionComponent(true);

            entity_.template get<helios::physics::collision::components::CollisionComponent<Handle_type>>()
        ...
        CollisionConfig& dealDamage(
            ...
            entity_.template getOrAdd<helios::gameplay::damage::components::DamageDealerComponent<Handle_type>>()
