...
export module helios.gameplay.builder.entity.builders.configs.LifecycleConfig;
...
export namespace helios::gameplay::builder::entity::builders::configs {
    ...
    /**
     * @brief Configuration for lifecycle management on a Entity.
     *
    ...
    public:
        ...
        /**
         * @brief Constructs a LifecycleConfig for the given Entity.
         *
         * @param entity Non-owning pointer to the target entity.
         */
        explicit LifecycleConfig(Entity& entity) : entity_(entity) {}
        ...
        LifecycleConfig& useDelayedComponentEnabler() {
            ...
            entity_.template getOrAdd<helios::gameplay::lifecycle::components::DelayedComponentEnabler<Handle_type>>();
