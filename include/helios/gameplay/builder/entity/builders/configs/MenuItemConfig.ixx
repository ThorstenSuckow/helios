 ...
 * @brief Fluent configuration for menu item Entities.
 */
module;
...
export module helios.gameplay.builder.entity.builders.configs.MenuItemConfig;
...
export namespace helios::gameplay::builder::entity::builders::configs {
    ...
    class MenuItemConfig {
        ...
        /**
         * @brief Pointer to the parent menu Entity.
         */
        ...
        void attach() {
            ...
            mc->addMenuItem(entity_.handle());
        }
    public:

        /**
         * @brief Constructs a MenuItemConfig for the given Entity.
         *
        ...
        explicit MenuItemConfig(
            Entity entity,
            Entity& parentMenu
        ) : entity_(entity), parentMenu_(&parentMenu) {


            entity_.template getOrAdd<helios::ui::widgets::components::UiStyleComponent<Handle_type>>();
            entity_.template getOrAdd<helios::ui::widgets::components::UiStateComponent<Handle_type>>();
        ...
        MenuItemConfig& normalColor(const helios::math::vec4f color) {
            entity_.template get<helios::ui::widgets::components::UiStyleComponent<Handle_type>>()
        ...
        MenuItemConfig& actionId(const helios::ui::widgets::types::ActionId actionId) {
            ...
            entity_.template add<helios::ui::widgets::components::UiActionComponent<Handle_type>>(actionId);
