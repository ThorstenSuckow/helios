...
export module helios.gameplay.builder.entity.builders.configs.MeshRenderableConfig;
...
export namespace helios::gameplay::builder::entity::builders::configs {
    ...
    /**
     * @brief Fluent configuration for setting up a Renderable on a Entity.
     *
    ...
    public:
        ...
        /**
         * @brief Constructs a MeshRenderableConfig for the given Entity.
         *
