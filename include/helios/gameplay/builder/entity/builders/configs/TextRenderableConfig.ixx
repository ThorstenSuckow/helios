 ...
 * @brief Fluent configuration for text renderable Entities.
 */
module;
...
export module helios.gameplay.builder.entity.builders.configs.TextRenderableConfig;
...
export namespace helios::gameplay::builder::entity::builders::configs {
    ...
    public:
        ...
        /**
         * @brief Constructs a TextRenderableConfig for the given Entity.
         *
        ...
        /**
         * @brief Builds the text renderable and attaches to a parent Entity.
         *
        ...
        SceneNodeConfig<Entity> attachTo(Entity parent) {
            ...
            SceneNodeConfig<Entity> scn{entity_};
        ...
        /**
         * @brief Builds the text renderable and adds components to the Entity.
         *
        ...
        TextRenderableConfig& build() {
            ...
            if (isUiText_ || usesNumberFormatter_ || usesTimeFormatter_) {
                entity_.template add<helios::ui::widgets::components::UiTextComponent<Handle_type>>(renderable.get());
                isUiText_ = false;
            }

            if (usesTimeFormatter_) {
                auto& tfc = entity_.template add<helios::ui::layout::components::TimeFormatterComponent<Handle_type>>();
                tfc.setFormat(
                    timestampFormat_,
            ...
            if (usesNumberFormatter_) {
                entity_.template add<helios::ui::layout::components::NumberFormatterComponent<Handle_type>>()
