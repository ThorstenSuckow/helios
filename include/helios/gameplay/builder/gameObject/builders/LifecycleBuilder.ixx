...
export module helios.gameplay.builder.gameObject.builders.LifecycleBuilder;

import helios.gameplay.builder.gameObject.builders.configs.LifecycleConfig;
...
export namespace helios::gameplay::builder::gameObject::builders {
    ...
    public:
         ...
         */
        helios::gameplay::builder::gameObject::builders::configs::LifecycleConfig<Entity> lifecycle() {
            return helios::gameplay::builder::gameObject::builders::configs::LifecycleConfig<Entity>{gameObject_};
        }
