...
export module helios.gameplay.builder.gameObject.builders.ObserverBuilder;

import helios.gameplay.builder.gameObject.builders.configs.ObserverConfig;
...
export namespace helios::gameplay::builder::gameObject::builders {
    ...
    public:
         ...
         */
        [[nodiscard]] helios::gameplay::builder::gameObject::builders::configs::ObserverConfig<Entity> observe() const {
            return helios::gameplay::builder::gameObject::builders::configs::ObserverConfig<Entity>{gameObject_};
        }
