...
export module helios.gameplay.builder.gameObject.builders.configs.SceneNodeConfig;
...
export namespace helios::gameplay::builder::gameObject::builders::configs {
    ...
    public:
         ...
         */
        explicit SceneNodeConfig(const Entity gameObject) : gameObject_(gameObject) {}
