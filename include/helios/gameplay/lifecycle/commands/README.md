# helios::gameplay::lifecycle::commands
...
`WorldLifecycleAction` is defined in the sibling `types` submodule (`helios.gameplay.lifecycle.types`).
...
@namespace helios::gameplay::lifecycle::commands
