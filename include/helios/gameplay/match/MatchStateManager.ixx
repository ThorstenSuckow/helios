...
export module helios.gameplay.match.MatchStateManager;
...
export namespace helios::gameplay::match {
     ...
     */
    using MatchStateManager = helios::engine::state::StateManager<helios::gameplay::match::types::MatchState>;
