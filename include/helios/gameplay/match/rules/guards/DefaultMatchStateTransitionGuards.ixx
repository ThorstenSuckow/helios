...
export module helios.gameplay.match.rules.guards.DefaultMatchStateTransitionGuards;
...
import helios.gameplay.match.components.LivesComponent;

using namespace helios::gameplay::match::types;
using namespace helios::engine::state::types;
using namespace helios::gameplay::match::components;

export namespace helios::gameplay::match::rules::guards {
