...
import helios.gameplay.scoring.ScorePoolSnapshot;
import helios.gameplay.scoring.MaxScorePoolSnapshot;
...
export namespace helios::gameplay::scoring {
    ...
    class ScorePool {
         ...
         */
        helios::gameplay::scoring::types::ScorePoolId scorePoolId_;
         ...
         */
        helios::gameplay::scoring::types::ScorePoolRevision  maxScoreRevision_{};
         ...
         */
        helios::gameplay::scoring::types::ScorePoolRevision revision_{};
    ...
    public:
         ...
         */
        explicit ScorePool(const helios::gameplay::scoring::types::ScorePoolId scorePoolId)
         ...
         */
        [[nodiscard]] helios::gameplay::scoring::types::ScorePoolId id() const noexcept {
            return scorePoolId_;
        }
         ...
         */
        void addScore(const helios::gameplay::scoring::types::ScoreValueContext& scoreContext) {
         ...
         */
        [[nodiscard]] helios::gameplay::scoring::types::ScorePoolRevision revision() const noexcept {
            return revision_;
        }
         ...
         */
        [[nodiscard]] helios::gameplay::scoring::ScorePoolSnapshot snapshot() const noexcept {
         ...
         */
        [[nodiscard]] helios::gameplay::scoring::types::ScorePoolRevision maxScoreRevision() const noexcept {
         ...
         */
        [[nodiscard]] helios::gameplay::scoring::MaxScorePoolSnapshot maxScoreSnapshot() const noexcept {
