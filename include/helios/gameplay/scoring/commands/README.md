# helios::gameplay::scoring::commands
...
updateContext.queueCommand<EngineCommandBuffer, UpdateScoreCommand>(std::move(scoreValueContext));
```
...
@namespace helios::gameplay::scoring::commands
