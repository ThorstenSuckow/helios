...
export module helios.gameplay.scoring.commands.UpdateScoreCommand;

import helios.gameplay.scoring.types;



export namespace helios::gameplay::scoring::commands {
    ...
    class UpdateScoreCommand  {
         ...
         */
        helios::gameplay::scoring::types::ScoreValueContext scoreContext_;
    ...
    public:
        ...
        explicit UpdateScoreCommand(
            helios::gameplay::scoring::types::ScoreValueContext scoreContext
         ...
         */
        [[nodiscard]] const helios::gameplay::scoring::types::ScoreValueContext& scoreContext() const & noexcept {
         ...
         */
        [[nodiscard]] helios::gameplay::scoring::types::ScoreValueContext scoreContext() && noexcept {
