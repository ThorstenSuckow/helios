...
export module helios.gameplay.scoring.components.MaxScoreObserverComponent;
...
export namespace helios::gameplay::scoring::components {
    ...
    class MaxScoreObserverComponent {
        ...
        friend class helios::gameplay::scoring::systems::MaxScoreObserverClearSystem;
    ...
    public:
         ...
         */
        void setMaxScorePoolSnapshot(const helios::gameplay::scoring::MaxScorePoolSnapshot& snapshot) noexcept {
