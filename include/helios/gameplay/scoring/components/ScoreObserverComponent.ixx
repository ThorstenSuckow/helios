...
export module helios.gameplay.scoring.components.ScoreObserverComponent;
...
export namespace helios::gameplay::scoring::components {
    ...
    class ScoreObserverComponent {
        ...
        friend class helios::gameplay::scoring::systems::ScoreObserverClearSystem;
    ...
    private:
         ...
         */
        helios::gameplay::scoring::ScorePoolSnapshot snapshot_;
    ...
    public:
         ...
         */
        void setScorePoolSnapshot(const helios::gameplay::scoring::ScorePoolSnapshot& snapshot) noexcept {
