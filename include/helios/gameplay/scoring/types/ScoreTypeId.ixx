...
export module helios.gameplay.scoring.types.ScoreTypeId;
 ...
 */
template<>
struct std::hash<helios::gameplay::scoring::types::ScoreTypeId> {
   std::size_t operator()(const helios::gameplay::scoring::types::ScoreTypeId& id) const noexcept {
        return id.value();
    }
