...
import helios.runtime.pooling.GameObjectPoolRegistry;

import helios.runtime.pooling.GameObjectPoolConfig;
...
export namespace helios::runtime::pooling {
    ...
    class GameObjectPoolManager {
         ...
         */
        helios::runtime::pooling::GameObjectPoolRegistry<THandle> pools_{};
         ...
         */
        std::unordered_map<
            helios::runtime::pooling::types::GameObjectPoolId,
        ...
        void fillPool(
            ...
            helios::runtime::world::GameObject gameObjectPrefab
        ) {
            ...
            for (size_t i = 0; i < space; i++) {
                helios::runtime::world::GameObject go = gameWorld_->clone(gameObjectPrefab);
                go.setActive(false);
                go.onRelease();
                gameObjectPool->addInactive(go.handle());
            }
    ...
    public:
         ...
         */
        [[nodiscard]] helios::runtime::pooling::GameObjectPoolSnapshot poolSnapshot(
            const helios::runtime::pooling::types::GameObjectPoolId gameObjectPoolId
        ) const {
            auto* gameObjectPool = pool(gameObjectPoolId);
         ...
         */
        std::optional<helios::runtime::world::GameObject> release(
            const helios::runtime::pooling::types::GameObjectPoolId gameObjectPoolId,
         ...
         */
        [[nodiscard]] std::optional<helios::runtime::world::GameObject> acquire(
            const helios::runtime::pooling::types::GameObjectPoolId gameObjectPoolId
        )  {
            THandle entityHandle{};
        ...
        void init(helios::runtime::world::GameWorld& gameWorld) {
            ...
            for (const auto& [gameObjectPoolId, poolConfig] : poolConfigs_) {
                ...
                auto pool = std::make_unique<helios::runtime::pooling::GameObjectPool<THandle>>(
                    poolConfig->amount);
                ...
                for (auto [entity, pic] : gameWorld.view<
                    THandle,
                    helios::runtime::pooling::components::PrefabIdComponent<THandle>>().whereEnabled()) {
         ...
         */
        [[nodiscard]] GameObjectPool<THandle>* pool(
            const helios::runtime::pooling::types::GameObjectPoolId gameObjectPoolId
        ) const {
