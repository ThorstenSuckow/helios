...
export module helios.runtime.spawn.commands.ScheduledSpawnPlanCommand;
...
using namespace helios::runtime::spawn::scheduling;
using namespace helios::runtime::world::types;
export namespace helios::runtime::spawn::commands {
    ...
    class ScheduledSpawnPlanCommand {
         ...
         */
        helios::runtime::spawn::types::SpawnProfileId spawnProfileId_;

        /**
         * @brief The spawn plan containing rule ID and amount.
         */
        helios::runtime::spawn::scheduling::SpawnPlan spawnPlan_;
