...
export module helios.runtime.spawn.policy.SpawnRule;
...
export namespace helios::runtime::spawn::policy {
    ...
    class SpawnRule {
         ...
         */
        const helios::runtime::spawn::types::SpawnRuleId spawnRuleId_;
    ...
    public:
         ...
         */
        [[nodiscard]] helios::runtime::spawn::scheduling::SpawnPlan evaluate(
            ...
            if (spawnCondition_->isSatisfied(amount, spawnRuleState, poolSnapshot, updateContext)) {
                return helios::runtime::spawn::scheduling::SpawnPlan{spawnRuleId_, amount};
            }

            return helios::runtime::spawn::scheduling::SpawnPlan{spawnRuleId_, 0};
        }
         ...
         */
        [[nodiscard]] helios::runtime::spawn::types::SpawnRuleId spawnRuleId() const noexcept {
            return spawnRuleId_;
        }
