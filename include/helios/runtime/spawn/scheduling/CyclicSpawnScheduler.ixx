...
export module helios.runtime.spawn.scheduling.CyclicSpawnScheduler;

import helios.runtime.spawn.scheduling.SpawnScheduler;
import helios.runtime.spawn.scheduling.DefaultRuleProcessor;

import helios.runtime.world.UpdateContext;
import helios.runtime.spawn.SpawnManager;
import helios.runtime.world.GameWorld;
import helios.runtime.spawn.scheduling.SpawnPlan;
import helios.runtime.spawn.scheduling.ScheduledSpawnPlan;
...
export namespace helios::runtime::spawn::scheduling {
    ...
    struct RuleConfig {
         ...
         */
        helios::runtime::spawn::types::SpawnProfileId spawnProfileId{helios::core::types::no_init};

        /**
         * @brief The spawn rule controlling when spawns occur.
         */
        std::unique_ptr<helios::runtime::spawn::policy::SpawnRule<THandle>> spawnRule;
    };
    ...
    class CyclicSpawnScheduler : public SpawnScheduler<THandle> {
         ...
         */
        std::unordered_map<
            helios::runtime::spawn::types::SpawnRuleId,
            helios::runtime::spawn::policy::SpawnRuleState
        > spawnRuleStates_;
    ...
    public:
         ...
         */
        void commit(const helios::runtime::spawn::types::SpawnRuleId spawnRuleId, const size_t spawnCount) noexcept override{
