...
export module helios.runtime.spawn.scheduling.DefaultRuleProcessor;

import helios.runtime.spawn.scheduling.RuleProcessor;
...
export namespace helios::runtime::spawn::scheduling {
    ...
    public:
        ...
        SpawnPlan processRule(
            ...
            const auto* spawnManager = gameWorld.tryManager<helios::runtime::spawn::SpawnManager<THandle>>();
