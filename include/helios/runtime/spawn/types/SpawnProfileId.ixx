...
export module helios.runtime.spawn.types.SpawnProfileId;
 ...
 */
template<>
struct std::hash<helios::runtime::spawn::types::SpawnProfileId> {
    std::size_t operator()(const helios::runtime::spawn::types::SpawnProfileId& id) const noexcept {
        return id.value();
    }
