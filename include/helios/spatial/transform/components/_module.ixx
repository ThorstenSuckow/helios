/**
 * @file _module.ixx
 * @brief Aggregate module for helios::spatial::transform::components namespace.
 */
...
export import helios.spatial.transform.components.WorldTransformStateComponent;
export import helios.spatial.transform.components.LocalTransformComponent;
