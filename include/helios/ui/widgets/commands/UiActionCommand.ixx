...
export module helios.ui.widgets.commands.UiActionCommand;
...
export namespace helios::ui::widgets::commands {
    ...
    class UiActionCommand  {
         ...
         */
        helios::ui::widgets::types::ActionId actionId_;
    ...
    public:
        ...
        explicit UiActionCommand(
            ...
            const helios::ui::widgets::types::ActionId actionId) :
         ...
         * @return The ActionId.
         */
        [[nodiscard]] helios::ui::widgets::types::ActionId actionId() const noexcept {
            return actionId_;
        }
