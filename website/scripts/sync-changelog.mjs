...
async function main() {
  ...
  const syncMappings = [
    ...
    {
      src: path.join(repoRoot, 'examples', 'archive', 'milestones', 'simple_cube_rendering', 'README.md'),
    ...
    {
      src: path.join(repoRoot, 'examples', 'archive', 'milestones', 'game_controller_input', 'README.md'),
    ...
    {
      src: path.join(repoRoot, 'examples', 'archive', 'milestones', 'spaceship_control', 'README.md'),
    ...
    {
      src: path.join(repoRoot, 'examples', 'archive', 'milestones', 'spaceship_shooting', 'README.md'),
    ...
    {
      src: path.join(repoRoot, 'examples', 'archive', 'milestones', 'enemy_spawn', 'README.md'),
    ...
    {
      src: path.join(repoRoot, 'examples', 'archive', 'milestones', 'collision_detection', 'README.md'),
    ...
    {
      src: path.join(repoRoot, 'examples', 'archive', 'milestones', 'render_text_demo', 'README.md'),
    ...
    {
      src: path.join(repoRoot, 'examples', 'archive', 'milestones', 'scoring_demo', 'README.md'),
    ...
    {
      src: path.join(repoRoot, 'examples', 'archive', 'milestones', 'runtime_test', 'README.md'),
